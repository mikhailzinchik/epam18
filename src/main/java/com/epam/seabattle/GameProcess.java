...
/**
 * GameProcess is a class where the interaction of the Player and the ComputerBehavior takes place.
 */
public class GameProcess {
    ...
    public GameProcess() {
        ...
        enemy = new ComputerBehavior(this);
    }
    ...
    public OurField getEnemyMap() {
        return enemy.getMap();
    }

    public OurField getPlayerMap() {
